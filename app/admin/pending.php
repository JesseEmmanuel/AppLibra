...
$books = "SELECT tblbooks.bookID AS bookID, tblbooks.bookCover AS bookCover, tblbooks.bookTitle AS bookTitle, tblbooks.publishID AS publishID, 
          ...
          FROM tblbooks INNER JOIN tblpublication ON tblbooks.publishID = tblpublication.publishID WHERE (((tblbooks.bookStatus)=0))";
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header  justify-content-between align-items-center">
                        <h4 class="card-title">Pending Uploads</h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu p-0">
                                                <a class="dropdown-item" href="admin_approve.php?id=<?php echo $rows['bookID']; ?>">Approve</a>
