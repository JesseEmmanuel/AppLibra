...
$books = "SELECT tblbooks.bookID AS bookID, tblbooks.bookCover AS bookCover, tblbooks.bookTitle AS bookTitle, tblbooks.publishID AS publishID, 
          ...
          FROM tblbooks INNER JOIN tblpublication ON tblbooks.publishID = tblpublication.publishID WHERE (((tblbooks.bookStatus)=1))";
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-pill badge-success mb-1"><small><?php echo $categories_rows['categoryName']; ?></small></span>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <?php 
